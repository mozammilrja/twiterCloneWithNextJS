...
const Sidebar = () => {
  return (
    <div className='hidden sm:flex flex-col items-center xl:w-[340px] p-2 fixed h-full'>
      ...
      <div className='space-y-2.5 mt-4 xl:ml-24 '>
      ...
      <button className='hidden xl:inline ml-auto mt-4 bg-[#1d9bf0] text-white rounded-full w-[12rem] h-[40px] text-lg font-bold shadow-md hover:bg-[#1a8cd8] '>
        Tweet
      </button>
      <div className='text-[#d9d9d9]  flex items-center justify-center hoverAnimation xl:ml-24 xl:mr-auto mt-auto  '>
        <img
        ...
        <div className='hidden xl:inline leading-5'>
          <h4 className='font-bold '>firebase133</h4>
          <p className='text-[#6e767d]'>@firebase133</p>
        </div>
